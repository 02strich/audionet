...
if __name__ == "__main__":
	print 'BASSASIO implemented Version', hex(BASSASIOVERSION)
	print 'BASSASIO real Version', hex(BASS_ASIO_GetVersion())
	if not BASS_ASIO_Init(0):
		print 'BASS_ASIO_Init error', get_error_description(BASS_ASIO_ErrorGetCode())
	else:
		if not BASS_ASIO_Free():
			print 'BASS_ASIO_Free error', get_error_description(BASS_ASIO_ErrorGetCode())
